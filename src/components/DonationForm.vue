      ...
      >
        ...
        >
          <div class="flex items-start">
            ...
            <div class="ml-4">
              <p class="font-bold text-xl text-brand-primaryDark">
                Vielen Dank für Ihre Spende! 🎉
              </p>
              <p class="text-sm mt-1 text-brand-primaryDark/80">
                Ihr Beitrag hilft uns, unser Ziel zu erreichen.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            <label for="name" class="block text-gray-700 font-semibold mb-2">
              <span class="flex items-center">
                <svg
                  class="w-5 h-5 mr-2 text-brand-primary"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
